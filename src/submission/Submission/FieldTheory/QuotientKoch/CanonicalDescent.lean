import Submission.FieldTheory.QuotientKoch.CanonicalIdentification
...
def finiteKochDescent
    ...
    D.TameKochRelator →*
      initialGaloisGroup :=
  Submission.RRDescen.PQuot.residualDescent
    (p := 3)
...
lemma koch_descent_comp
  ...
  exact Submission.RRDescen.PQuot.residualDescentComp
      (p := 3)
      D.fiveRelatorPresented
      initial_galois_residually
...
lemma koch_descent_continuous
  ...
  exact Submission.RRDescen.PQuot.residualDescent_continuous
    (p := 3)
    D.fiveRelatorPresented
    initial_galois_residually
...
lemma koch_descent_surjective
  ...
  exact Submission.RRDescen.PQuot.residualDescent_surjective
    (p := 3)
    D.fiveRelatorPresented
    initial_galois_residually
...
lemma koch_extra_comap
  ...
  exact Submission.RRDescen.PQuot.extraResidualComap
      (p := 3)
      D.fiveRelatorPresented
      initial_galois_residually
...
lemma koch_extra_closed
  ...
  exact Submission.RRDescen.PQuot.extra_residual_closed
    (p := 3)
    D.fiveRelatorPresented
    initial_galois_residually
...
lemma factorization_theorem_descent
  ...
  constructor
  · intro hkernel
    apply (Submission.RRDescen.PQuot.residual_descent_relator
        (p := 3)
        D.fiveRelatorPresented
  ...
  · intro hInjective
    apply le_antisymm
    · simpa using (Submission.RRDescen.PQuot.residual_descent_relator
          (p := 3)
          D.fiveRelatorPresented
...
lemma koch_limit_descent
  ...
  simpa [inverseLimitDescent, Function.comp_def] using
    (Submission.RRDescen.PQuot.residual_descent_quotient
      (p := 3)
      D.fiveRelatorPresented
