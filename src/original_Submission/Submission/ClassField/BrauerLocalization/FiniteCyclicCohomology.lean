...
import Submission.ClassField.GlobalClass.FiniteCompletion
...
theorem surjectivity_nonsplit_primes
    (hbaseChange : FiniteSpectralChange.{u})
    (h46 : Submission.CField.NIndex.NontrivialNonsplitPrimes.{u}) :
    InvariantSurjectivityBridge.{u} :=
  surjectivity_change_frobenius
    hbaseChange
    (Submission.CField.NIndex.numberElementStatement
      h46)
...
theorem surjectivity_change_away
    ...
    (hnorm : Submission.CField.NIndex.SplitAwayBridge.{u}) :
    InvariantSurjectivityBridge.{u} :=
  surjectivity_change_frobenius
    hbaseChange
...
theorem global_artin_fundamental
  ...
  cohomology_direct_cardinality
    Submission.CField.CIdeles.ideleCohomologyClaims
    hArtin h81
