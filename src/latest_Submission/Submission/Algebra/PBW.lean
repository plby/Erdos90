import Submission.Algebra.Filtered
...
theorem pbwIndependenceTheorem {R : Type u} [Semiring R]
  ...
  | mk ordered vec independent spans =>
      simpa [Submission.Algebra.pOBasis.vec,
        Submission.Algebra.pOBasis.ordered] using independent
...
theorem pbwSpanningTheorem {R : Type u} [Semiring R]
  ...
  | mk ordered vec independent spans =>
      simpa [Submission.Algebra.pOBasis.vec,
        Submission.Algebra.pOBasis.ordered] using spans
