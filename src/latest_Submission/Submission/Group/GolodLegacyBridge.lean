...
import Submission.Group.FoxAssociatedGraded
import Submission.Group.HilbertJenningsFox
import Submission.Group.IdealJenningsFox
...
`Submission.Group` modules; this file preserves the original theorem surface.
-/
