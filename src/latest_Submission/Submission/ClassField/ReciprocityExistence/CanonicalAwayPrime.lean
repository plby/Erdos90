import Submission.ClassField.LocalReciprocity.PadicRootCore
import Submission.ClassField.ArtinReciprocity.FrobeniusExamples
...
open Submission.CField.LRecip.PNProof
