import Towers.Group.GolodShafarevich
...
noncomputable def oNSubgro.toFiniteIndex {G : Type u} [Group G]
    ...
    Towers.Group.fISubgro G :=
  Towers.Group.fISubgro.ofNormal N.normal N.finiteQuotient
...
noncomputable def fCQuota.abstract_fin_quot {G : Type u} [Group G]
    ...
    Towers.Group.aFQuot G :=
  Towers.Group.aFQuot.ofSurjective Q.map Q.surjective
