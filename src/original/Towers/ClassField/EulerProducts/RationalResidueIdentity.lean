import Towers.ClassField.EulerProducts.PartialZeta
...
`ℚ(√-5)`, the Towers ANT development supplies the class-number computation
...
theorem sqrt_neg_ramifies :
  ...
  Towers.CField.Examples.sqrt_neg_ramifies
