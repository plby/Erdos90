...
import Towers.ClassField.Characters.HasDirichletDensity
...
theorem splits_completely_dvd
  ...
  · rintro ⟨P, hP, he, hf⟩
    ...
    have hdegrees :=
      @Towers.NumberTheory.Milne.inertia_ramification_dvd
...
def primesSplittingCompletely
  ...
  {p | ∃ hp : p.Prime,
    (Rat.HeightOneSpectrum.primesEquiv.symm ⟨p, hp⟩) ∈
      Towers.NumberTheory.Milne.splittingPrimes ℚ K}
