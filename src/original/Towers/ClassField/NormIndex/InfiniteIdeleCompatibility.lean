import Towers.ClassField.NormIndex.CompletionProductNorm
import Towers.ClassField.NormIndex.IdeleNormCompatibility
import Towers.ClassField.IdeleCohomology.ArchimedeanProduct
