...
theorem semilinear_conjugate_one
  ...
  rw [semilinearConjugate,
    Submission.CField.FGroups.coeff_one_subst
      (constantCoeff_subst_eq_zero hinverse0 f hf0),
    PowerSeries.coeff_map,
    Submission.CField.FGroups.coeff_one_subst hinverse0]
...
theorem coeff_subst_x
  ...
  rw [Submission.CField.FGroups.coeff_one_subst hinverse0,
...
theorem subst_semilinear_factor
  ...
  apply Eq.symm
  apply Submission.CField.FGroups.subst_inverse_unique
...
theorem one_subst
  ...
  rw [Submission.CField.FGroups.coeff_one_subst htheta0,
    hi1, one_mul]
