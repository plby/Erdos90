...
abbrev StabilizationKernel
  ...
  Submission.TCTex.RFTransv.PTStab
    n leftWeight rightWeight
...
abbrev IndexFiberCounts
  ...
  Submission.TCTex.TFIdx.SatisfiesTransversalCounts
      n leftWeight rightWeight hleftWeight hrightWeight
...
theorem stabilization_index_counts
    ...
    StabilizationKernel n leftWeight rightWeight ↔
      IndexFiberCounts
        n leftWeight rightWeight hleftWeight hrightWeight :=
  Submission.TCTex.TFIdx.transversal_stabilization_counts
...
def raw_fiber_counts
    ...
    (hcounts :
      IndexFiberCounts
        n leftWeight rightWeight hleftWeight hrightWeight) :
    Submission.TCTex.FIProf.RFProf
      n leftWeight rightWeight hleftWeight hrightWeight :=
  Submission.TCTex.TFIdx.PTStab.idxFiberProfile
