import Mathlib
import Submission.Algebra.CompletedGroupAlgebra.CoreBoundedWords
    ...
    have hKmap_top (N : OpenNormalSubgroup F) :
      ...
      have hmod_le : modPFrattini p Q ≤ _root_.frattini Q := by
        ...
        · dsimp [pPowerSubgroup]
          ...
          exact Submission.p_group_frattini hQ g
        · rw [_root_.commutator_def]
          apply (Subgroup.commutator_le).2
          intro a _ha b _hb
          exact Submission.p_commutator_frattini hQ a b
