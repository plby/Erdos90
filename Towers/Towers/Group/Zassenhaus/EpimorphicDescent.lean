import Towers.Group.Zassenhaus.AFiltration
import Towers.Group.Zassenhaus.ZassenhausEquality
...
theorem sequence_lower_surjective
  ...
  rw [subgroup_power_surjective _ _ f hf,
    Towers.Edmonton.central_series_surjective f hf]
...
theorem q_logarithmic_surjective
  ...
  simpa only [subgroup_power_surjective _ _ f hf,
    Towers.Edmonton.central_series_surjective f hf] using hmap
