...
def sqrtFiveEmbedding :
    Towers.NumberTheory.SNFive →+* SqrtFiveField where
...
private local instance sqrtNegFive_orderAlgebra :
    Algebra Towers.NumberTheory.SNFive SqrtFiveField :=
  sqrtFiveEmbedding.toAlgebra

private local instance sqrtNegFive_orderScalarTower :
    IsScalarTower ℤ Towers.NumberTheory.SNFive
      SqrtFiveField :=
...
def sqrtOrderEmbedding :
    Towers.NumberTheory.SNFive →+* SqrtBiquadraticOrder :=
...
private local instance sqrtNegFive_topOrderAlgebra :
    Algebra Towers.NumberTheory.SNFive SqrtBiquadraticOrder :=
  sqrtOrderEmbedding.toAlgebra

private local instance sqrtNegFive_topOrderScalarTower :
    IsScalarTower ℤ Towers.NumberTheory.SNFive SqrtBiquadraticOrder :=
  IsScalarTower.of_algebraMap_eq' (by
    ext z <;>
...
private local instance sqrtNegFive_topOrder_moduleFinite :
    Module.Finite Towers.NumberTheory.SNFive SqrtBiquadraticOrder :=
  Module.Finite.right ℤ Towers.NumberTheory.SNFive SqrtBiquadraticOrder
